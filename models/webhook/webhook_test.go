			...
			Events: `
{
	...
	"events": {
		...
		"workflow_run_blocked": true,
		"workflow_run_cancelled": true,
		"workflow_run_failure": true,
		"workflow_run_running": true,
		"workflow_run_skipped": true,
		"workflow_run_success": true,
		"workflow_run_waiting": true,
...
`,
		...
		assert.Equal(t, []string{
			...
			string(webhook_module.HookEventWorkflowRunBlocked),
			string(webhook_module.HookEventWorkflowRunCancelled),
			string(webhook_module.HookEventWorkflowRunFailure),
			string(webhook_module.HookEventWorkflowRunRunning),
			string(webhook_module.HookEventWorkflowRunSkipped),
			string(webhook_module.HookEventWorkflowRunSuccess),
			string(webhook_module.HookEventWorkflowRunWaiting),
